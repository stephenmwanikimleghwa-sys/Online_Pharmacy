...
function AppLayout() {
  ...
  const isAuthPage = ["/login", "/force-password-change", "/branch/select"].includes(
    location.pathname,
  );
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <ErrorBoundary>
              {/* Flat route table — nested path="*" Routes rendered blank screens after redirect */}
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  <Route
                    ...
                    element={<ProtectedRoute element={ForcePasswordChange} />}
                  />
                  <Route
                    path="/branch/select"
                    element={
                      <ProtectedRoute element={BranchSelectionScreen} allowedRoles={["admin"]} />
                    }
                  />
                  ...
                  <Route
                    path="/financials"
                    element={<ProtectedRoute element={FinancialDashboard} allowFinancials />}
                  />
                  <Route path="/quotations" element={<ProtectedRoute element={QuotationsDashboard} />} />
                  <Route
                    path="/clinical"
                    element={
                      <ProtectedRoute element={ClinicalDashboard} allowedRoles={["admin", "pharmacist"]} />
                    }
                  />
                  <Route
                    path="/clinical/:id"
                  ...
                  <Route
                    ...
                    element={
                      <ProtectedRoute element={ValidatePrescription} allowedRoles={["pharmacist"]} />
                    }
                  />
                  <Route
                  ...
                  <Route
                    ...
                    element={
                      <ProtectedRoute element={RestockRequests} allowedRoles={["admin", "pharmacist"]} />
                    }
                  />
                  <Route
                    path="/reports"
                    element={
                      <ProtectedRoute
                        ...
                        allowedRoles={["admin", "pharmacist", "auditor", "cashier"]}
                      />
                    }
                  />
                  <Route
