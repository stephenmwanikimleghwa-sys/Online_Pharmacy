...
//   };
// 
//   // Registration is disabled in the client. New users must be created by an admin.
//   const register = async () => {
//     // Intentionally disabled: registration flow removed to enforce admin-controlled user creation.
//     return { success: false, error: { detail: "Registration is disabled. Contact an administrator." } };
//   };
// 
//   const logout = () => {
//     // Clear auth state
...
//     token,
//     login,
//     // register intentionally not exported as a usable flow; kept for backwards-compat checks
//     logout,
//     updateProfile,
//     getDashboardPath,
